...
describe('venue entrance lifecycle', () => {
  it('prepares children during the brief entrance and reveals them after the minimum interval', () => {
    const html = render(); expect(html).toContain('Venue chat'); expect(html).toContain('visibility:hidden'); mountEffects();
    vi.advanceTimersByTime(VENUE_ENTRANCE_MS - 1); expect(render()).toContain('data-testid="venue-entrance"');
