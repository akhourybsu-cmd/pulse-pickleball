...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email to get started on Pulse Pickleball</Preview>
    <Body style={main}>
      <Container style={outer}>
        ...
        <Container style={card}>
          <Heading style={h1}>Welcome to PULSE</Heading>
          <Text style={text}>
            Thanks for joining Pulse Pickleball! Confirm your email
            (<Link href={`mailto:${recipient}`} style={link}>{recipient}</Link>)
            to start finding matches, joining round robins, and tracking your play.
          </Text>
        ...
        <Text style={brand}>
          <Link href={siteUrl} style={brandLink}>PulsePB.com</Link>
        </Text>
      </Container>
    </Body>
  </Html>
