...
- Free venue community covers use the same 96–112px desktop cap. Their mobile sizing and chat exclusion remain unchanged.
...
- Local operations callback verified; player fixture hides staff controls. Mobile header remains 198.5px at 390px width, with no overflow.
