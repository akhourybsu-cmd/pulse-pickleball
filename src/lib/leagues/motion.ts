/**
 * Ladder League motion system — one source of truth for timing, easing,
 * and the handful of framer-motion variants used across the league
 * surface. Durations follow the product's interaction spec:
 *
