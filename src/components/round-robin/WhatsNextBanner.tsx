...
export function WhatsNextBanner({
  ...
  // NOTE: the old live "Active Round" control card lived here. It
  // duplicated the round picker + scoring surface already rendered by
  // the schedule carousel below, so it was removed. Live states now
  // fall through to the compact prompt below (score / close round /
  // complete event).
