  ...
  "rounded-lg border bg-card text-card-foreground shadow-sm transition-[box-shadow,border-color,background-color,transform,color] duration-200",
  {
    variants: {
      variant: {
        ...
        "pulse-accent": "border-l-4 border-l-[hsl(var(--accent-lime))] hover:shadow-lg",
        interactive: "border-l-4 border-l-[hsl(var(--accent-lime))] hover:shadow-lg hover:scale-[1.01]",
      },
    },
    defaultVariants: {
      variant: "default",
