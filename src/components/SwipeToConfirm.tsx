    ...
    <div className="space-y-2">
      <div
        ...
        className={cn(
          ...
          isConfirmed ? "bg-[#CC9332]" : "bg-muted border-2 border-border"
        )}
      >
        {/* Progress fill */}
        <div
          className="absolute inset-0 bg-[#CC9332] transition-all duration-100"
          style={{
        ...
        >
          {isConfirmed ? (
            <Check className="w-8 h-8 text-[#CC9332] animate-scale-in" />
          ) : (
