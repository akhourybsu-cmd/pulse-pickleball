...
const AdminLegacyTools = () => {
  ...
  const handleRecalculateRatings = async () => {
    if (!window.confirm("Recalculate ratings for every player? This is a platform-wide maintenance action.")) return;
  ...
  return (
    <AdminLayout title="Archived session tools" subtitle="Legacy tools retained for maintenance. Use venue and league owner workspaces for current operations.">
...
export default AdminLegacyTools;
