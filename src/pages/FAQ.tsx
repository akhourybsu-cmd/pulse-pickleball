...
const FAQ_SCHEMA_ITEMS: { q: string; a: string }[] = [
  { q: "What is PULSE?", a: "PULSE is the home for pickleball players. Track matches, earn a Pulse rating, join leagues and round robins, find events, and connect with your local community." },
  ...
  { q: "How do I join a round robin?", a: "Open the Play tab, browse live round robins near you, and tap Join. The host approves and you'll get court assignments in the app." },
];
