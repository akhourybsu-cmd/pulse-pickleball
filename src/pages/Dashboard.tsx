            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-3 mt-4">
                <Button 
                  ...
                  className="shadow-[var(--shadow-glow)] w-full sm:w-auto hover:brightness-90 hover:ring-2 hover:ring-primary/20 transition-all"
                ...
                {homeCourtId && (
                  <Button 
                    variant="secondary" 
                    size="lg" 
                    className="w-full sm:w-auto shadow-sm hover:shadow-md hover:ring-2 hover:ring-secondary/20 transition-all"
