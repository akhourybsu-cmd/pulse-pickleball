...
export default function GroupManage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="sticky top-0 z-30 bg-gradient-to-b from-primary/[0.06] via-background to-background backdrop-blur-xl border-b border-border/60 pt-[env(safe-area-inset-top)]">
