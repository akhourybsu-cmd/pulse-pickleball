...
import { Plus, Loader2, Shuffle, Edit, Trash2, CheckCircle2, Award, ArrowLeft } from "lucide-react";
...
export default function TournamentDivisionDetailNew() {
  const { id: tournamentId, divisionId } = useParams();
  ...
  const handleGenerateMatches = async () => {
    ...
    if (insertError) {
      ...
      toast({
        ...
        description: `${matchesToCreate.length} matches created across ${numRounds} rounds`,
      });
